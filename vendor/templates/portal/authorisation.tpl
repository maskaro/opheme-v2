												...
												<div class="form-group">
													...
													<div class="input-group">
														...
														<span class="input-group-btn">
															<button {if $authModule eq "instagram"}style="background-color: rgb(50, 85, 130);border-color:rgb(50, 85, 130);" {/if}type="button" class="btn btn-primary" onclick="{literal}${/literal}('form#new-sma-account-{$authModule}').submit();" >
